          ...
          <div className="space-y-8">
            ...
            <section className="bg-white dark:bg-slate-800 rounded-2xl p-8 shadow-sm border border-slate-200 dark:border-slate-700">
              ...
              <div className="space-y-4 text-slate-700 dark:text-slate-300">
                <div>
                  <strong className="text-slate-900 dark:text-white">Operator:</strong> SmartAVR Financial Ecosystem SRL, persoană juridică română, cod unic de înregistrare: J40/1234/2023
                </div>
                <div>
                  <strong className="text-slate-900 dark:text-white">Adresă:</strong> Strada Principală Nr. 15, Sector 1, București, România
                </div>
                <div>
                  <strong className="text-slate-900 dark:text-white">Email:</strong> contact@smartavr.ro
                </div>
                <div>
                  <strong className="text-slate-900 dark:text-white">Telefon:</strong> +40 722 123 456
                </div>
                <div>
                  <strong className="text-slate-900 dark:text-white">Website:</strong> https://smartavr.ro
                </div>
              </div>
            </section>
            ...
            <section className="bg-white dark:bg-slate-800 rounded-2xl p-8 shadow-sm border border-slate-200 dark:border-slate-700">
              ...
              <div className="space-y-4 text-slate-700 dark:text-slate-300">
                <div>
                  <h3 className="text-lg font-black text-slate-900 dark:text-white mb-3">2.1. Categorii de Date</h3>
                ...
                <div>
                  <h3 className="text-lg font-black text-slate-900 dark:text-white mb-3">2.2. Metode de Colectare</h3>
                ...
                <div>
                  <h3 className="text-lg font-black text-slate-900 dark:text-white mb-3">2.3. Baza Legală</h3>
                ...
                <div>
                  <h3 className="text-lg font-black text-slate-900 dark:text-white mb-3">2.4. Perioada de Păstrare</h3>
                  <ul className="list-disc list-inside space-y-2 ml-6">
            ...
            <section className="bg-white dark:bg-slate-800 rounded-2xl p-8 shadow-sm border border-slate-200 dark:border-slate-700">
              ...
              <div className="space-y-4 text-slate-700 dark:text-slate-300">
                <div>
                  <h3 className="text-lg font-black text-slate-900 dark:text-white mb-3">3.1. Scopul Principal</h3>
                ...
                <div>
                  <h3 className="text-lg font-black text-slate-900 dark:text-white mb-3">3.2. Temeiul Legal</h3>
                ...
                <div>
                  <h3 className="text-lg font-black text-slate-900 dark:text-white mb-3">3.3. Consimțământul Utilizatorului</h3>
            ...
            <section className="bg-white dark:bg-slate-800 rounded-2xl p-8 shadow-sm border border-slate-200 dark:border-slate-700">
              ...
              <div className="space-y-4 text-slate-700 dark:text-slate-300">
                <div>
                  <h3 className="text-lg font-black text-slate-900 dark:text-white mb-3">4.1. Categorii de Destinatari</h3>
                  <ul className="list-disc list-inside space-y-2 ml-6">
                ...
                <div>
                  <h3 className="text-lg font-black text-slate-900 dark:text-white mb-3">4.2. Transferuri Internaționale</h3>
                ...
                <div>
                  <h3 className="text-lg font-black text-slate-900 dark:text-white mb-3">4.3. Măsuri de Securitate</h3>
                  <ul className="list-disc list-inside space-y-2 ml-6">
            ...
            <section className="bg-white dark:bg-slate-800 rounded-2xl p-8 shadow-sm border border-slate-200 dark:border-slate-700">
              ...
              <div className="space-y-4 text-slate-700 dark:text-slate-300">
                <div>
                  <h3 className="text-lg font-black text-slate-900 dark:text-white mb-3">5.1. Dreptul de Acces</h3>
                  <ul className="list-disc list-inside space-y-2 ml-6">
                ...
                <div>
                  <h3 className="text-lg font-black text-slate-900 dark:text-white mb-3">5.2. Dreptul de Rectificare</h3>
                ...
                <div>
                  <h3 className="text-lg font-black text-slate-900 dark:text-white mb-3">5.3. Dreptul de a Fi Uitat</h3>
                ...
                <div>
                  <h3 className="text-lg font-black text-slate-900 dark:text-white mb-3">5.4. Dreptul de Opunere</h3>
                ...
                <div>
                  <h3 className="text-lg font-black text-slate-900 dark:text-white mb-3">5.5. Dreptul de a Depune Plângere</h3>
                ...
                <div>
                  <h3 className="text-lg font-black text-slate-900 dark:text-white mb-3">5.6.Restrictionări Procesare Automată</h3>
            ...
            <section className="bg-white dark:bg-slate-800 rounded-2xl p-8 shadow-sm border border-slate-200 dark:border-slate-700">
              ...
              <div className="space-y-4 text-slate-700 dark:text-slate-300">
                <div>
                  <h3 className="text-lg font-black text-slate-900 dark:text-white mb-3">6.1. Cookies</h3>
                ...
                <div>
                  <h3 className="text-lg font-black text-slate-900 dark:text-white mb-3">6.2. Tehnologii de Tracking</h3>
                ...
                <div>
                  <h3 className="text-lg font-black text-slate-900 dark:text-white mb-3">6.3. LocalStorage</h3>
            ...
            <section className="bg-white dark:bg-slate-800 rounded-2xl p-8 shadow-sm border border-slate-200 dark:border-slate-700">
              ...
              <div className="space-y-4 text-slate-700 dark:text-slate-300">
                <div>
                  <h3 className="text-lg font-black text-slate-900 dark:text-white mb-3">7.1. Măsuri Tehnice și Organizatorice</h3>
                  <ul className="list-disc list-inside space-y-2 ml-6">
                ...
                <div>
                  <h3 className="text-lg font-black text-slate-900 dark:text-white mb-3">7.2. Incidente de Securitate</h3>
